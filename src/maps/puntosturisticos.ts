export const puntosTuristicos = {
  ...
  'Pampeana': {
    ...
    'Santa Fe': [
      ...
      { "name": "Parque Independencia", "lat": -32.9588, "lon": -60.6621 },
      { "name": "Plaza 25 de Mayo", "lat": -32.9456, "lon": -60.6377 },
      { "name": "Museo Municipal de Bellas Artes Juan B. Castagnino", "lat": -32.9611, "lon": -60.6645 },
      { "name": "Teatro El Círculo", "lat": -32.9515, "lon": -60.6392 },
      { "name": "Balneario La Florida", "lat": -32.8880, "lon": -60.6875 },
      { "name": "Centro Cultural Roberto Fontanarrosa", "lat": -32.9453, "lon": -60.6407 },
      { "name": "Museo de Arte Contemporáneo de Rosario (MACRO)", "lat": -32.9416, "lon": -60.6401 }
    ]
